...
ninja= createSprite(30, displayHeight-180, 50, 50);
...
function roofground(){
    ...
    for(i=400;i<4000;i=i+600){
  roof=createSprite(i,displayHeight/2,370,10)
  
//roof.x=displayWidth/2+50
  roofgroup.add(roof)
  console.log(roof.x)
